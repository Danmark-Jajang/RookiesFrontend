/**
 * mui 라이브러리에서 제공하는 툴패드 활용 대시보드 구성
 *  - 기본적인 레이아웃 제공
 *  - 라우팅 제공
 *  - 머터리얼 디자인 제공
 *  - 버전이 올라갈 때마다 기능이 수정될 수 있다(version 확인잘하기)
 * 
 * 레이아웃 적용시
 *  - 기존 샘플 가져오기
 *      - 이후 필요한 기능 중심으로 세팅하기
  ...
  */
  return (
    ...
    >
      ...
      >
        {/* 메뉴별 상세페이지 컴포넌트, pathname이 변경되는 새로고침 발생 */}
